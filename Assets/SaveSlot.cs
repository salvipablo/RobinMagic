...
public class SaveSlot : MonoBehaviour
{
  ...
  private void Start()
  {
    ...
    {
      if (SaveManager.Instance.IsSlotEmpty(slotNumber)) SaveGameConfirmed();
      else DisplayOverrideWarning();
    });
  }

  private void Update()
  {
    if (SaveManager.Instance.IsSlotEmpty(slotNumber)) buttonText.text = "Empty";
    else buttonText.text = PlayerPrefs.GetString("Slot" + slotNumber + "Description");
  }
