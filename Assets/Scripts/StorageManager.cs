...
public class StorageManager : MonoBehaviour
{
  ...
  private void PopulateStorage( GameObject storageUI )
  {
    ...
    foreach (Transform child in storageUI.transform) uiSlots.Add(child.gameObject);
  ...
  private void RecalculateStorage(GameObject storageUI)
  {
    ...
    foreach(GameObject obj in toBeDeleted) Destroy(obj);
  }

  public void SetSelectedStorage( StorageBox storage ) => selectedStorage = storage;

  private GameObject GetRelevantUI( StorageBox storage ) => storageBoxSmallUI;
  #endregion
}
