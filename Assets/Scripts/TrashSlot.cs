...
public class TrashSlot : MonoBehaviour, IDropHandler, IPointerEnterHandler, IPointerExitHandler
{
  ...
  {
    if (draggedItem != null && draggedItem.GetComponent<InventoryItem>().isTrashable == true) imageComponent.sprite = trash_opened;
  }

  public void OnPointerExit( PointerEventData eventData )
  {
    if (draggedItem != null && draggedItem.GetComponent<InventoryItem>().isTrashable == true) imageComponent.sprite = trash_closed;
  }
}
